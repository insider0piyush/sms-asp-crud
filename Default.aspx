<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="sms._Default" %>
    ...
    <form runat="server" id="form1">
        <table border="0" cellpadding="7px" style="margin-top:32px;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="Sid" name= "Sid" runat="server" style="padding-inline:12px;padding-top:9px;padding-bottom:9px;width:256px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="font-size:19px;padding-right:17px;padding-left:12px;">
        ...
        <asp:Button ID="btnAdd" name="btnAdd" runat="server" text="Add Student"
            style="padding-left:17px;padding-right:17px;padding-top:7px;padding-bottom:7px;background-color:dodgerblue;color:white;
               font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;
                   font-size:17px;outline-color:dodgerblue;border-color:dodgerblue;border-radius:12px;margin-inline-start:64px;margin-top:32px;" OnClick="StudentAdd"></asp:Button>

        <asp:Button ID="bnView" name="btnAdd" runat="server" text="View Record"
            style="padding-left:17px;padding-right:17px;padding-top:7px;padding-bottom:7px;background-color:orange;color:white;
               font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;
                   font-size:17px;outline-color:orange;border-color:orange;border-radius:12px;margin-inline-start:32px;margin-top:32px;" OnClick="StudentView"></asp:Button>
    </form>
</body>
</html>
